...
### 功能说明
玩家可以使用摄像头捕获真实头像，替换游戏角色的头部。头像会随角色移动、转向和动作变化。

### 使用方法
1. 在角色选择界面，按 **Q** 键为玩家1捕获头像
2. 按 **P** 键为玩家2捕获头像
3. 首次使用时浏览器会请求摄像头权限，请允许访问
4. 捕获的头像会在游戏中显示为圆形，覆盖在角色头部

### 技术要求
- 需要 HTTPS 或 localhost 环境
- 浏览器需要支持 `getUserMedia` API
- 需要用户授予摄像头访问权限

### 详细文档
- [功能说明](CAMERA_FEATURE.md)
- [测试指南](TEST_CAMERA.md)
- [快速开始](QUICK_START.md)
